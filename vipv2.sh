...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Dev > Joys Tunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Joys Tunneling ® ${NC}${YELLOW}(${NC} ${green} LT ⭐ ${NC}${YELLOW})${NC}"
echo -e " © jo lali ngibadah ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/minuredire/vipv2/main/"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6281329322508"}]]}' 
...
wget -q https://raw.githubusercontent.com/minuredire/vipv2/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
